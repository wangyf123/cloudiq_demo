// @ts-nocheck
/**
 * Base on https://github.com/umijs//opt/cloudiqcode/node_modules/umi-request
 */
import {
  extend,
  Context,
  ...
  RequestInterceptor,
  ResponseInterceptor,
} from '/opt/cloudiqcode/node_modules/umi-request';
// @ts-ignore
...
import useUmiRequest, { UseRequestProvider } from '/opt/cloudiqcode/node_modules/@ahooksjs/use-request';
import {
  BaseOptions,
  ...
  PaginatedParams,
  PaginatedResult,
} from '/opt/cloudiqcode/node_modules/@ahooksjs/use-request/lib/types';
