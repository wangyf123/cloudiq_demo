...
const ProportionSalesBack = ({
  ...
  <Card
    ...
    actions={[
      <Statistic title="OPEN" value={0} valueStyle={{ color: '#50A0D6' }} />,
...
<Row><Typography.Title style={{ color: '#0076CE'}}>0</Typography.Title></Row><Row><Typography.Title level={4} style={{ color: '#0076CE'}}>Total P1 Incidents</Typography.Title></Row>
</div>
</Col>
</Row>
    </div>
...
export default ProportionSalesBack;
